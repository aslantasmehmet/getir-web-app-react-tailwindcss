...
import PageLangauge from "../pagesEn/PageLangauge";
import Login from "../pagesEn/Login";
import Register from "../pagesEn/Register";
        ...
        <nav className="flex gap-x-8 text-sm font-semibold">
          ...
          <div
            ...
            <label for="my-modal-1" className="cursor-pointer">
              ...
              English(EN)
              <Routes>
                <Route path="/" element={<PageLangauge />}></Route>
              </Routes>
            </label>
          </div>
